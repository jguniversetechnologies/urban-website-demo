        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8">
            ...
            <div className="flex flex-wrap gap-4">
              <a
                href="#"
                className="bg-black text-white px-4 py-2 rounded-lg flex items-center space-x-2 hover:bg-gray-900 transition"
              >
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8">
            ...
            <p className="text-blue-100 mb-6">
              Join our network of service professionals and grow your business with regular bookings.
            </p>
            <Link
